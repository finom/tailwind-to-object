...
const supportedLiteralClasses = {
  ...
  'border-l': (value: string) => (isColor(value) ? 'border-left-color' : 'border-left-width'),
  'border-r': (value: string) => (isColor(value) ? 'border-right-color' : 'border-right-width'),
  'border-t': (value: string) => (isColor(value) ? 'border-top-color' : 'border-top-width'),
  'border-b': (value: string) => (isColor(value) ? 'border-bottom-color' : 'border-bottom-width'),
